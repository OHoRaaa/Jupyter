...
use sqldb;
insert into testtbl1 select emp_no, first_name, last_name from employees.employees; -- 데이터 밖에서 테이블에 접근
...
-- right ('문자열', num) : 문자열 오른쪽으로부터 num갯수 만큼 요소출력
select left('abfsdfsaq', 3);
select right('abfsdfsaq', 3);
